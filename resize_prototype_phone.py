...
# 1. Update the normal mode .phone css block
...
# 2. Update normal mode .app-viewport border-radius for cleaner fit inside new rounded corners
...
# 3. Update recording mode .phone css block to use the exact matching inner dims
...
print("Successfully resized prototype phone to match landing page mockup!")

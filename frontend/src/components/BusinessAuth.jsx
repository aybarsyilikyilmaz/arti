...
export default function BusinessAuth() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-24 px-4 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-2xl">
        <h2 className="text-center text-3xl font-extrabold text-gray-900 tracking-tight">
          {isLogin ? 'İşletme Hesabınıza Giriş Yapın' : 'İşletmenizi Artı+\'ya Taşıyın'}
        </h2>
        <p className="mt-2 text-center text-sm text-gray-600">
          {isLogin ? 'Fazla gıdaları gelire dönüştürün, çevreyi koruyun.' : 'Sadece 4 adımda kaydınızı tamamlayın, aynı gün ilk kutunuzu yayınlayın.'}
        </p>
      </div>

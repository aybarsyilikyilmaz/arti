...
# Fix the button on screen 4 to call goTo(5)
btn_search = r"""          <button style="width: 100%; background: #388E3C; color: #fff; border: none; padding: 1\.2rem; border-radius: 999px; font-weight: 700; font-size: 1\.1rem; cursor: pointer; transition: transform 0\.1s;" onmousedown="this\.style\.transform='scale\(0\.97\)';" onmouseup="this\.style\.transform='scale\(1\)';">
            Ödemeyi Onayla 250 ₺
          </button>"""
btn_replace = """          <button onclick="goTo(5)" style="width: 100%; background: #388E3C; color: #fff; border: none; padding: 1.2rem; border-radius: 999px; font-weight: 700; font-size: 1.1rem; cursor: pointer; transition: transform 0.1s;" onmousedown="this.style.transform='scale(0.97)';" onmouseup="this.style.transform='scale(1)';">
            Ödemeyi Onayla 250 ₺
          </button>"""
...
content = re.sub(screen5_search, screen5_new, content, flags=re.DOTALL)
